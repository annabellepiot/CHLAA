...
public:
  ...
  static shared_state build_shared(cpp11::list parameters) {
    ...
    const real_type contact_rate = dust2::r::read_real(parameters, "contact_rate", static_cast<real_type>(0.050000000000000003));
  ...
  static data_type build_data(cpp11::list data, const shared_state& shared) {
    ...
    auto has_deaths = dust2::r::read_real(data, "has_deaths", NA_REAL);
    auto obs_interval = dust2::r::read_real(data, "obs_interval", NA_REAL);
    return data_type{cases, deaths, has_deaths, obs_interval};
  }
  ...
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    const real_type p2p_force = shared.contact_rate * (I_eff / shared.N);
  ...
  static real_type compare_data(real_type time, const real_type* state, const data_type& data, const shared_state& shared, internal_state& internal, rng_state_type& rng_state) {
    ...
    odin_ll += unless_nan(monty::density::negative_binomial_mu(data.deaths, shared.obs_size_deaths, data.has_deaths * shared.death_reporting_rate * obs_inc_deaths, true));
    return odin_ll;
  }
};
